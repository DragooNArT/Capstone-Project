...
import com.example.brewersnotepad.mobile.listeners.GrainRemoveListener;
...
public class GrainListAdapter<T> extends ArrayAdapter<GrainEntry> {
    ...
    private GrainRemoveListener removeListener;
    public GrainListAdapter(Context context, int resource) {
        super(context, resource);
        this.inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        removeListener = new GrainRemoveListener(this);
    }
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        removeListener.addEntry(deleteGrainBtn.getId(),position);
